...
const ConsentPage = () => {
  ...
  const handleAgree = () => {
    if (!checkBoxStates.isOver18Checked || !checkBoxStates.isConsentChecked || !checkBoxStates.isReadAndAcceptChecked) {
    ...
    <SafeAreaView>
      <ScrollView>
        ...
        <View className="flex justify-center p-4 px-8 flex-1">
          ...
          <CheckBox
            handleCheckChanges={() => handleCheckBoxChange('isConsentChecked')}
